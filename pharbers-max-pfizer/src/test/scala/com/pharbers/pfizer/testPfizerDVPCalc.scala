...
import com.pharbers.pfizer.calc.phPfizerForDVPMaxJob
...
object testPfizerDVPCalc extends App {
    val job_id: String = "pfizer_dvp_job_id"
    val panel_name: String = "cae79bd9-ab18-42ab-9145-7c53fa6c6a1d"
    ...
    val map: Map[String, String] = Map(
        ...
        "p_current" -> "1",
        "p_total" -> "1",
        "universe_file" -> "hdfs:///data/pfizer/pha_config_repository1804/Pfizer_Universe_DVP.csv",
        "coef_file" -> "hdfs:///data/pfizer/pha_config_repository1804/Pfizer_CoefForDVP.csv"
    )
...
//    val lactor: ActorSelection = system.actorSelection(xmppFactor.getNullActor)
    ...
    val result = phPfizerForDVPMaxJob(map)(send).perform()
