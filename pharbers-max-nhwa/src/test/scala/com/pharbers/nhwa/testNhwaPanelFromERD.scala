...
import com.pharbers.nhwa.panel.phNhwaPanelFromERDJob
import com.pharbers.pactions.actionbase.{MapArgs, StringArgs}
import com.pharbers.spark.phSparkDriver

object testNhwaPanelFromERD extends App {
    ...
    val map: Map[String, String] = Map(
        ...
        "job_id" -> job_id,
        "prod_lst" -> "恩华",
        "cpa_file" -> "/repository/cpa/5ca069bceeefcc012918ec72/20181227",
        ...
        "pha_path" -> "/repository/pha",
        "hosp_path" -> "/repository/hosp",
        "prod_path" -> "/repository/prod_etc3/5ca069bceeefcc012918ec72",
        "prod_atc_path" -> "/repository/atc_table3",
        "product_dev_path" -> "/repository/prod_dev3",
        "market_path" -> "/repository/market3/5ca069bceeefcc012918ec72"
    )
    ...
    val result = phNhwaPanelFromERDJob(map)(send).perform()
